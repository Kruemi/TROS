...
VALUES
-----------------------------------------------
-- Für Gebäude, Einheiten, Eigenschaften, siehe unter TROS_Config_Text.sql
-----------------------------------------------
...
-- ALLIANCE
	...
	("LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_TROS_STAUFFACHER_ANY",	"de_DE",	"Lasst uns sein ein einzig Volk von Brüdern"),
...
-- KUDOS & WARNINGS
	...
	-- AI Warnings
	("LOC_DIPLO_WARNING_EXIT_LEADER_TROS_STAUFFACHER_ANY",						"de_DE",	"Obacht!"),
	...
	("LOC_DIPLO_WARNING_EXIT_LEADER_TROS_ALFRED_ANY",							"de_DE",	"Achtung!"),
...
-- DENOUNCE
	...
	("LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_TROS_ALFRED_ANY",		"de_DE",	"Du bisch en Tubel!"),
	("LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_TROS_JAKOB_ANY",			"de_DE",	"Dir sit so ne Glünggu!"),
	...
	("LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_TROS_ALFRED_ANY",			"de_DE",	"Du bisch en Tubel!"),
	("LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_TROS_JAKOB_ANY",			"de_DE",	"Dir sit so ne Glünggu!"),
