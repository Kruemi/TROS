...
-- DOM
	...
	Jörg Jenatsch, wisst diese Umstände zu Eurem Vorteil zu nutzen und baut ein Reich auf, dass die Zeiten überdauern wird."),
...
--------------------------------------------------------------------
	...
	"Plaecholder."),
	("LOC_PEDIA_LEADERS_PAGE_LEADER_TROS_JENATSCH_CHAPTER_HISTORY_PARA_11",	"en_US",
	"Plaecholder."),
