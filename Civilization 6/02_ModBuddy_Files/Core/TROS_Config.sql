...
-- CIV8  - Zürich (Alfred) --------------------
	...
	-- Unique Infrastructure
	('Players:Expansion1_Players',	'CIVILIZATION_TROS_ZURICH',				'LEADER_TROS_ALFRED', 		'BUILDING_TROS_ZURICH_UI',				'ICON_BUILDING_TROS_ZURICH_UI',				'LOC_BUILDING_TROS_ZURICH_UI_NAME',				'LOC_BUILDING_TROS_ZURICH_UI_DESCRIPTION',				20			),
-- CIV9  - Bern (Jakob) -----------------------
	-- Unique Unit
